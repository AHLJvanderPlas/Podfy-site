...
Real secret values (Cloudflare API token, RESEND_API_KEY, TURNSTILE_SECRET, PORTAL_SESSION_SECRET) are catalogued in `/Users/alexander/Documents/Projects/Notes/.secrets/podfy.md`. Never paste a real secret value into this file — reference the vault instead.
