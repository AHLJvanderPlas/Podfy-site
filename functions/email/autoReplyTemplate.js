        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:520px;background:#FBF9F3;border:1px solid #E4E2DC;border-radius:4px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:28px 22px 20px;color:#0E1116;">
              ...
              <!-- Greeting (plain opener, not a headline) -->
              <p style="margin:0 0 4px;font-size:13px;color:#5A6473;line-height:1.5;">
                Hi {{name}},
              </p>
              ...
              <!-- Main headline -->
              <h1 style="margin:0 0 8px;font-size:20px;font-weight:600;line-height:1.25;letter-spacing:-0.02em;color:#0E1116;">
                We’ve received your message about PODFY.
              </h1>
              <p style="margin:0 0 22px;font-size:13px;color:#5A6473;line-height:1.65;">
                Thanks for reaching out. Your request is safely in our inbox and will be reviewed by a person, not a bot. We usually respond within one business day, often sooner.
              </p>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 22px;">
                <tr>
                  <td style="background:#EDE8DC;border:1px solid #E4E2DC;border-left:3px solid #D24A1F;border-radius:4px;padding:12px 14px;">
                    <p style="margin:0;font-family:SFMono-Regular,Menlo,Consolas,’Courier New’,monospace;font-size:10px;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;color:#0E1116;line-height:1.6;">
                      Request received — We’ll get back to you as soon as we can.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 22px;">
                <tr>
                  <td style="background:#EDE8DC;border:1px solid #E4E2DC;border-left:3px solid #D24A1F;border-radius:4px;padding:12px 14px;">
                    ...
                    <p style="margin:0 0 4px;font-size:13px;color:#5A6473;line-height:1.6;">· <strong style="color:#0E1116;">Free View · 60 days:</strong> instantly view recent PODs in the delivery portal.</p>
                    <p style="margin:0 0 4px;font-size:13px;color:#5A6473;line-height:1.6;">· <strong style="color:#0E1116;">Magic link access:</strong> no passwords, no setup — open from your inbox.</p>
                    <p style="margin:0;font-size:13px;color:#5A6473;line-height:1.6;">· <strong style="color:#0E1116;">Driver-friendly upload:</strong> CMR → photo → done. Zero friction.</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 22px;">
                <tr>
                  <td width="50%" style="padding:0 4px 4px 0;">
                    <a href="https://podfy.net/free-tier-demo.html" style="display:block;padding:11px 10px;background:#0E1116;color:#F5F2EA;text-decoration:none;font-family:system-ui,-apple-system,sans-serif;font-size:11px;font-weight:600;letter-spacing:0.07em;text-transform:uppercase;text-align:center;border-radius:4px;">
                      FREE TIER DEMO
                    </a>
                  </td>
                  <td width="50%" style="padding:0 0 4px 4px;">
                    <a href="https://podfy.app" style="display:block;padding:10px 10px;color:#0E1116;text-decoration:none;font-family:system-ui,-apple-system,sans-serif;font-size:11px;font-weight:500;letter-spacing:0.07em;text-transform:uppercase;text-align:center;border:1px solid #CFCBC0;border-radius:4px;">
                      SAMPLE UPLOAD
                    </a>
                  </td>
                </tr>
                <tr>
                  <td width="50%" style="padding:0 4px 0 0;">
                    <a href="https://podfy.net/pricing" style="display:block;padding:10px 10px;color:#0E1116;text-decoration:none;font-family:system-ui,-apple-system,sans-serif;font-size:11px;font-weight:500;letter-spacing:0.07em;text-transform:uppercase;text-align:center;border:1px solid #CFCBC0;border-radius:4px;">
                      EXPLORE PLANS
                    </a>
                  </td>
                  <td width="50%" style="padding:0 0 0 4px;">
                    <a href="https://podfy.net" style="display:block;padding:10px 10px;color:#0E1116;text-decoration:none;font-family:system-ui,-apple-system,sans-serif;font-size:11px;font-weight:500;letter-spacing:0.07em;text-transform:uppercase;text-align:center;border:1px solid #CFCBC0;border-radius:4px;">
                      LEARN MORE
                    </a>
                  </td>
                </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 22px;">
                <tr>
                  <td style="background:#EDE8DC;border:1px solid #E4E2DC;border-left:3px solid #D24A1F;border-radius:4px;padding:12px 14px;">
                    ...
                    <p style="margin:0 0 8px;font-size:13px;color:#5A6473;line-height:1.6;">If you’d like us to tailor our advice, simply reply to this email and share:</p>
                    <p style="margin:0 0 4px;font-size:13px;color:#5A6473;line-height:1.6;">· Your typical POD volume per day or per week.</p>
                    <p style="margin:0 0 4px;font-size:13px;color:#5A6473;line-height:1.6;">· If drivers are internal, partner-based, or a mix.</p>
                    <p style="margin:0;font-size:13px;color:#5A6473;line-height:1.6;">· Where PODs should end up (email, TMS/WMS, shared folders, etc.).</p>
                  </td>
                </tr>
              </table>
...
export function buildAutoReply({ name, email, company, message }) {
  ...
  const companyBlock = safeCompany
    ? `<p style="margin:0 0 10px;font-size:13px;color:#5A6473;line-height:1.4;">Company: <strong style="color:#0E1116;">${escapeHtml(safeCompany)}</strong></p>`
    : "";
